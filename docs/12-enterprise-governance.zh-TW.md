...
在 2026 年 6 月 1 日之後，Business 與 Enterprise 的治理主軸改成 AI credits 與 usage-based billing。
...
對 Business / Enterprise 來說，2026/06/01 之後最乾淨的每人上限，就是 **user-level AI credit budget**。
...
GitHub 支援由 organization 或 enterprise owner 控制成員可用的 AI 模型。  
把這當成**官方支援的模型治理方式**。
...
外部 benchmark 可以做補充，但不能取代你自己的 Copilot usage data。
...
這套做法刻意很無聊：**先用便宜預設，再用例外方式擴 premium，最後用數據決定是否擴張。**
