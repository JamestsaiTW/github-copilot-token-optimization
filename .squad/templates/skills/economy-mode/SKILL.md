...
| Architecture, code review, security audits | `claude-opus-4.7` | `claude-sonnet-4.6` |
...
- **Don't override Layer 0 in economy mode.** If the user set `defaultModel: "claude-opus-4.7"`, they want quality. Economy mode only affects Layer 3 auto-selection.
