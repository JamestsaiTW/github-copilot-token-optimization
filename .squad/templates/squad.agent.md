...
| Visual/design work requiring image analysis | `claude-opus-4.7` | Premium | Vision capability required. Overrides cost rule. |
...
| Designer / Visual | `claude-opus-4.7` | Vision-capable model required | — (never downgrade — vision is non-negotiable) |
...
```
Premium:  claude-opus-4.7 → claude-opus-4.7-fast → claude-opus-4.7 → claude-sonnet-4.6 → (omit model param)
...
🎨 Redfoot (claude-opus-4.7 · vision) — designing color system
...
Premium: `claude-opus-4.7`, `claude-opus-4.7-fast`, `claude-opus-4.7`
